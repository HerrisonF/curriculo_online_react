    ...
    return(
        <Container className="resume_container">
            ...
            <VerticalTimelineElement
                    ...
                    icon={<BiBriefcase />}
                >
                    <h3 className="vertical-timeline-element-title">Especialista Mobile</h3>
                    <h4 className="vertical-timeline-element-subtitle">TOTVS</h4>
                    <p>
                    - Home office em Empresa líder de vendas em passagens de ônibus na América Latina  <br/>
- Responsável pela manutenção, adição de novas features e ideias para melhoria do produto em geral. <br/>
- Flutter(mobx,modular)/ android nativo(dagger, mvc, mvvm, databinding, retrofit,navigationView)/ iOS(Swift4), Firebase, SCRUM, JIRA, JENKINS, CODEMAGIC, integração de redes sociais, manutenção e refatoração do código para melhores práticas.
                    </p>
                </VerticalTimelineElement>
            <VerticalTimelineElement
                    className="vertical-timeline-element--work"
